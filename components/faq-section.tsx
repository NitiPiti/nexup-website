...
export function FAQSection() {
  const faqs = [
    {
      question: "What sets DocuChat apart from other chatbot builders?",
      answer: "DocuChat delivers unmatched answer quality and genuine GDPR compliance, without the premium price tag. As an EU-based company, we ensure complete data residency with all storage and AI processing on EU servers, backed by carefully vetted EU-based subprocessors. Our intuitive interface enables anyone to set up and deploy highly accurate chatbots in minutes, offering a unique combination of performance, compliance, and ease of use that sets us apart in the market."
    },
    {
      question: "How does DocuChat ensure the best answer quality?",
      answer: "DocuChat ensures superior answer quality by leveraging cutting-edge AI models, including top-tier alternatives to well-known OpenAI models. We employ proprietary strategies for document analysis, information retrieval, and answer generation. Our advanced algorithms excel at contextual understanding, allowing for hyper-accurate responses."
    },
    {
      question: "Is my data secure with DocuChat?",
    ...
    {
      question: "What AI models does DocuChat use? Can I use GPT-5?",
    ...
    {
      question: "What languages does DocuChat support?",
      answer: "DocuChat supports more than 80 different languages. This means that you can upload documents and ask questions in any of these supported languages, and your chatbots will respond in the language of the question."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes, DocuChat integrates seamlessly with Google Tag Manager (GTM) to track user interactions, questions asked, answers received, and other key metrics to help you understand and optimize chatbot performance."
    },
    {
      question: "Is there a free plan or trial?",
      answer: "While DocuChat doesn't offer a permanently free plan, we do provide a 14-day free trial. During this trial period, you can access all the features available in our Pro plan."
    }
  ]
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Have questions? We have answers. You can also reach out to us at hi@docuchat.io.
          </p>
        </div>
