...
export default function IntegrationsSection() {
  ...
  return (
    <section className="py-12 relative min-h-screen w-full overflow-hidden bg-white dark:bg-gray-900">
      <div className="relative flex flex-col items-center text-center z-10">
        <h1 className="my-6 text-4xl font-bold lg:text-7xl text-gray-900 dark:text-white">Integrations</h1>
